...
class FuzzyController(KesslerController):
    ...
    def create_aiming_fis(self):
        ...
        aiming_angle["negative"] = skf.trapmf(aiming_angle.universe, [-1.0, -1.0, -0.1, 0.0])
        aiming_angle["zero"] = skf.trapmf(aiming_angle.universe, [-1.0, -0.01, 0.01, 1.0])
        aiming_angle["positive"] = skf.trapmf(aiming_angle.universe, [0.0, 0.1, 0.9, 1.0])
