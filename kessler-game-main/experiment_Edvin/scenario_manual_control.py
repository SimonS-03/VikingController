...
from manual_controller import FuzzyController
...
set1_scenario = Scenario(name='Test Scenario',
                            ...
                            ship_states=[
                                {'position': (400, 400), 'angle': 0, 'lives': 30, 'team': 1, "mines_remaining": 3},
                                # {'position': (400, 600), 'angle': 90, 'lives': 3, 'team': 2, "mines_remaining": 3},
                            ],
                            map_size=(1000, 800),
                            time_limit=60,
...
set2_scenario = Scenario(name='Test Scenario',
                            ...
                            ship_states=[
                                {'position': (400, 400), 'angle': 180, 'lives': 3, 'team': 1, "mines_remaining": 3}
                                # {'position': (400, 600), 'angle': 90, 'lives': 3, 'team': 2, "mines_remaining": 3},
                            ],
                            map_size=(1000, 800),
                            time_limit=5,
...
score, perf_data = game.run(scenario=set2_scenario, controllers=[FuzzyController(), FuzzyController()])
