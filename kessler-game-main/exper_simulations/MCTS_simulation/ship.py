...
class Ship:
    ...
    # get the time to collision for the current position in the center of the ship
    def get_ttc(self, game_state: Dict, margin: float = 3) -> float:
        """
        ...
        for asteroid in game_state["asteroids"]:
            ...
            ship_pos = np.array(self.position)
            ship_vel = np.array(self.velocity)
            ...
            safe_distance = asteroid["radius"] + self.radius + margin
