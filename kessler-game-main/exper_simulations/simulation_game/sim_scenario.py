...
class SimulationScenario:
    ...
    def update_frame_limit(self, frame_limit: int):
        self.frame_limit = frame_limit
        return

    def clone(self):
        return SimulationScenario(name=self.name,
                                  asteroid_states=[a.copy() for a in self.asteroid_states],
                                  ship_states=[self.ship_states[0].copy()],
