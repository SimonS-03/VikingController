...
class ModuleChooserGenome(Genome):
    ...
    def geneNameToEdges(self) -> Dict[str, Any]:
        return {
            "ttc": self.edges["positive3"],
            "asteroids": self.edges["positive3"],
            "gradient": self.edges["positive3"],
            "angle": self.edges["positive3"],
            "module": self.edges["semiPositive3"]
        }
    ...
    def edges(self) -> Dict[str, Any]:
        return {
            ...
            "positive3": [(0, 0.75), (0, 1), (0.25, 1)],
            "semiPositive3": [(-0.5, 0.5), (0, 0.75), (0.25, 1)]
        }
