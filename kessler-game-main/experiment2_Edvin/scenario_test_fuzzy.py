...
from ind_threat_module import IndividualThreatModule
...
set1_scenario = Scenario(name='Test Scenario',
                            #num_asteroids=1,
                            asteroid_states=[{'position': (250, 370), 'angle': 0, 'speed': 50, 'size': 4}], 
                                             #{'position': (380, 500), 'angle': 280, 'speed': 30, 'size': 4}],
                            ship_states=[
                                {'position': (400, 400), 'angle': 130, 'lives': 30, 'team': 1, "mines_remaining": 3},
                                # {'position': (400, 600), 'angle': 90, 'lives': 3, 'team': 2, "mines_remaining": 3},
                            ],
                            map_size=(1000, 800),
                            time_limit=60,
...
set2_scenario = Scenario(name='Test Scenario',
                            num_asteroids=30,
                            #asteroid_states=[{'position': (200, 400), 'angle': 5, 'speed': 30, 'size': 4}],
                            ship_states=[
                                {'position': (400, 400), 'angle': 0, 'lives': 3000, 'team': 1, "mines_remaining": 3},
                                # {'position': (400, 600), 'angle': 90, 'lives': 3, 'team': 2, "mines_remaining": 3},
                            ],
                            map_size=(1000, 800),
                            time_limit=60,
...
score, perf_data = game.run(scenario=set2_scenario, controllers=[IndividualThreatModule(), IndividualThreatModule()])
