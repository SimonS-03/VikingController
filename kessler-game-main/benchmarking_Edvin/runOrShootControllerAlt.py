...
class combinedControllerAlt(KesslerController):
    ...
    def create_fis(self):
        ...
        rule7 = ctrl.Rule(ttc["low"] & nearby_asteroids["few"], danger["medium"])
    ...
    def actions(self, ship_state: Dict, game_state: Dict) -> Tuple[float, float, bool, bool]:
        ...
        norm_ttc = ttc/8 if ttc < 8 else 1

        nearby_asteroids = self.get_num_asteroids(game_state, ship_state)

        norm_nearby_asteroids = nearby_asteroids/4 if nearby_asteroids < 4 else 1
