...
class AsteroidChooser:
    ...
    def __init__(self, genome: AsteroidChooserGenome):
        ...
        rules.append(ctrl.Rule(size["small"], relevance["large"] % 0.2)) # was 0.2
        rules.append(ctrl.Rule(size["medium"], relevance["large"] % 0.3)) # 0.2
        rules.append(ctrl.Rule(size["large"], relevance["small"] % 0.2)) # 0.3
